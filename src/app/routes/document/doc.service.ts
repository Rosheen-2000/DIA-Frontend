...
export class DocService {
  ...
  public checkLockStatus(docid: string): Observable<{ msg: string, status: number, name: string }> {
    const form = new FormData();
    form.set('docid', docid);
    return this.http.post<{ msg: string, status: number, name: string }>(environment.baseUrl + 'doc/querystatus/', form);
  }
